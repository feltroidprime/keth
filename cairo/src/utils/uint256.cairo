...
// @dev The conversion maintains the integrity of the original 256-bit value within a 384-bit structure.
...
func uint256_to_uint384{range_check_ptr}(a: Uint256) -> UInt384 {
    ...
    let res = UInt384(low_96_low, low_32_high + POW_2_32 * high_64_low, high_64_high, 0);
    return res;
}
